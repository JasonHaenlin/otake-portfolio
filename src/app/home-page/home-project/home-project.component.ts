...
export class HomeProjectComponent implements OnInit {
  ...
  public projects: ProjectDef[] = [
    ...
    },
    {
      ...
      skills: [
        'Complete redesign of the old site',
        'Needs analysis and mockups with AdobeXD and Zeplin',
        'SEO optimization, images and Progressive Web App',
        'Lighthouse validation and checking'
      ],
      image: 'receptifvoyages.png',
      websiteLink: 'https://receptifvoyages.com'
    },
    {
